...
class MyCarouselSlider extends StatefulWidget {
  ...
  /// The initial page to show when first creating the [MyCarouselSlider].
  ///
  /// Defaults to 0.
  ...
  /// Animates the controlled [MyCarouselSlider] to the next page.
  ///
  ...
  /// Animates the controlled [MyCarouselSlider] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [MyCarouselSlider].
  ///
  ...
  /// Animates the controlled [MyCarouselSlider] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
